...
const ModalFeedback = ({ active, onClose }: PropsWithChildren<Props>) => {
  ...
  return (
    <Portal isVisible={active} onClick={onClose}>
        ...
        <div className={styles.contact_Blockright}>
          ...
          <div className={styles.modals}>
            ...
            <input className={styles.modal_window} onChange={onChangeEmail} value={email} placeholder="Ваш Email*"
                   type="email"/>
            <input className={styles.modal_window__sms} onChange={onChangeMessage} value={message}
