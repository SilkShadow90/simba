              ...
              if (typeof item[key as keyof T] === 'string') {
                return (
                  <div key={key} style={{
                    ...
                    <AdminButton text={'Отправить'}
                                 onClick={() => console.log('value', itemState[key as keyof T] as any)}/>
                    <div style={{ width: '20px' }}/>
                    <AdminButton text={'Вернуть'} type={'secondary'}
                                 onClick={() => console.log('value', item[key as keyof T] as any)}/>
                  </div>
                );
              }
